...
import { SingleInputDateRangePicker } from '../../../custom/Elements/CustomDateRengePicker';
import { BasicRangeShortcuts } from '../../../custom/Elements/CustomDateRengePicker';
    ...
    <React.Fragment>
      <div className="bg-screenBackgroundColor flex flex-col justify-between overflow-auto w-full p-1 overflow-hidden">
        ...
        <div className='flex w-full space-x-0 space-y-2 flex-col md:flex-row md:space-x-3 md:space-y-0 mb-3 '>
          ...
          <div className='md:w-64'>
            <Dropdown options={timePeriods} optionLabel="title" value={selectedDuration ? selectedDuration : { title: 'CustomDateRengePickerSelect Option' }} setValue={(value) => {
          ...
          {selectedDuration.title == "Custom" &&
            <SingleInputDateRangePicker fromDate={customPeriod.fromDate} toDate={customPeriod.toDate} setDate={onCustomPeriodChange} />
          }

          {/* {selectedDuration.title == "Custom" &&
            <BasicRangeShortcuts fromDate={customPeriod.fromDate} toDate={customPeriod.toDate} setDate={onCustomPeriodChange} />
          } */}
